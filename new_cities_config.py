"""
Configuration for 24 new cities to add to 30YearWeather
Ready to be copied into backend ETL files
"""

# ============================================================================
# FOR backend/etl.py - Add to LOCATIONS dictionary
# ============================================================================
...
# ============================================================================
# FOR backend/etl_tourism.py - Add to LOCATIONS list with country codes
# ============================================================================

TOURISM_LOCATIONS_TO_ADD = [
    # North America
...
# ============================================================================
# Print formatted output for easy copy-paste
# ============================================================================

if __name__ == "__main__":
    print("=" * 70)
    print("📋 READY TO COPY - CITIES FOR backend/etl.py")
    print("=" * 70)
    print("\nCopy this and add to LOCATIONS dict in backend/etl.py:\n")
    for slug, config in LOCATIONS_TO_ADD.items():
        print(f"    '{slug}': {config},")
    
    print("\n" + "=" * 70)
    print("📋 READY TO COPY - CITIES FOR backend/etl_tourism.py")
    print("=" * 70)
    print("\nCopy this and add to LOCATIONS list in backend/etl_tourism.py:\n")
    for location in TOURISM_LOCATIONS_TO_ADD:
        print(f"    {location},")
    
    print("\n" + "=" * 70)
    print(f"✅ Total: {len(LOCATIONS_TO_ADD)} new cities ready for import")
    print("=" * 70)
