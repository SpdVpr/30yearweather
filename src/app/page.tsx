  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `We currently provide 365-day weather forecasts for ${citySlugs.length}+ cities worldwide including Prague, Paris, Rome, Barcelona, London, Tokyo, Bali, Dubai, New York, and many more. Each city has detailed 30-year historical analysis covering all 366 days of the year.`
        }
      },
      {
        '@type': 'Question',
        ...
        <div className="relative z-10 w-full px-6 md:px-12 max-w-[1600px] mx-auto flex flex-col items-center text-center pt-20 pb-20">
          <div className="animate-fade-in-up">
            <span className="inline-block py-1.5 px-4 mb-6 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-bold uppercase tracking-widest">
              365-Day Weather Forecast • {citySlugs.length} Global Destinations
            </span>
            ...
            <p className="text-lg md:text-xl text-stone-100 mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium">
              Explore {citySlugs.length} global destinations with long-range weather forecasts based on 30 years of historical data analysis. NASA satellite data for accurate predictions up to 365 days ahead.
            </p>
            ...
            {[
              {
                ...
                slugs: ['prague', 'berlin', 'london', 'paris', 'rome', 'barcelona', 'vienna', 'zurich', 'athens', 'amsterdam', 'madrid', 'brussels', 'warsaw', 'budapest', 'lisbon', 'dublin', 'stockholm', 'copenhagen', 'oslo', 'helsinki', 'bratislava', 'istanbul', 'edinburgh', 'munich', 'venice', 'krakow', 'porto', 'lyon-fr', 'hamburg', 'seville', 'naples', 'valletta', 'rhodes', 'sofia', 'riga']
              },
              {
                title: "Asia & Pacific",
              ...
              {
                title: "Middle East",
                description: "Ancient heritage meets modern luxury.",
